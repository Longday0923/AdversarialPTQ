...
#    Internal functions
# ------------------------------------------------------------------------------
new_root = '/gpfs/accounts/eecs598w23_class_root/eecs598w23_class/shared_data/zhtianyu/datasets/'
def _load_cifar10(normalize=True):
    if normalize:
        trainset = datasets.CIFAR10(root=new_root,
        ...
        validset = datasets.CIFAR10(root=new_root,
